...
(function (a) {
    a(window).on("load", function () {
        var n = a(document.getElementById("showMenu"));
        var x = document.getElementsByClassName("header-dropdown-menu-item");
        ...
        n.on("click", function () {
            isMenuHide ? n.html('<img src="http://info.skyhookwireless.com/hubfs/new-assets/close-btn.svg">') : n.html('<img src="http://info.skyhookwireless.com/hubfs/new-assets/burger-menu.svg">');
            ...
            if (isMenuHide) {
                ...
                Array.prototype.forEach.call(u, function (y) {
                    y.innerHTML = '<img src="http://info.skyhookwireless.com/hubfs/new-assets/plus_btn.svg" class="plus-icon">'
                })
            }
        ...
        function q(B) {
            ...
            Array.prototype.forEach.call(y.children, function (C) {
            ...
            Array.prototype.forEach.call(u, function (C) {
                if (C === z) {
                    C.innerHTML = C.innerHTML === '<img src="http://info.skyhookwireless.com/hubfs/new-assets/arrow-down.svg" class="arrow-icon">' ? '<img src="http://info.skyhookwireless.com/hubfs/new-assets/plus_btn.svg" class="plus-icon">' : '<img src="http://info.skyhookwireless.com/hubfs/new-assets/arrow-down.svg" class="arrow-icon">'
                } else {
                    C.innerHTML = '<img src="http://info.skyhookwireless.com/hubfs/new-assets/plus_btn.svg" class="plus-icon">'
                }
            });
            Array.prototype.forEach.call(y.parentElement.children, function (C) {
